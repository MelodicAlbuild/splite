...
const settings = {
  ...
  selectSupportChannelId: db.prepare(
    "SELECT support_channel_id FROM settings WHERE guild_id = ?;"
  ),
  ...
  updateSupportChannelId: db.prepare(
    "UPDATE settings SET support_channel_id = ? WHERE guild_id = ?;"
  ),
...
const users = {
  ...
  selectMessageCount: db.prepare(
    "SELECT messageCount FROM users WHERE user_id = ? AND guild_id = ?;"
  ),
  ...
  updateAfk: db.prepare(
    "UPDATE users SET afk = ? WHERE user_id = ? AND guild_id = ?;"
  ),
  updateAfkTime: db.prepare(
    "UPDATE users SET afk_time = ? WHERE user_id = ? AND guild_id = ?;"
  ),
